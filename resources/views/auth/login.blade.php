            ...
            <div class="lex flex-col break-words bg-white border-2 shadow-md mt-20">
                ...
                <form class="py-10 px-5" method="POST" action="{{ route('login') }}" novalidate>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="email" type="email" class="p-3 bg-gray-200 rounded form-input w-full @error('email') @enderror" name="email" value="{{ old('email') }}" autocomplete="email" autofocus>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="password" type="password" class="p-3 bg-gray-200 rounded form-input w-full @error('password') @enderror" name="password" autocomplete="current-password">
                        @error('password')
                            <span class="bg-red-100 border-l-4 border-red-500 text-red-700 text-xs p-4 w-full mt-5" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
