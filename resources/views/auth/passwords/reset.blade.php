            ...
            <div class="lex flex-col break-words bg-white border-2 shadow-md mt-20">
                ...
                <form class="py-10 px-5" method="POST" action="{{ route('password.update') }}" novalidate>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="email" type="email" class="p-3 bg-gray-200 rounded form-input w-full @error('email') @enderror" name="email" value="{{ $email ?? old('email') }}" autocomplete="email" autofocus>
                        @error('email')
