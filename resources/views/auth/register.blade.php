...
<div class="container mx-auto">
    <div class="flex flex-wrap justify-center">
        <div class="w-full max-w-sm">
            <div class="lex flex-col break-words bg-white border-2 shadow-md mt-20">
                <div class="bg-gray-300 text-gray-700 uppercase text-center py-3 px-6 mb-0">
                    ...
                    <form class="py-10 px-5" method="POST" action="{{ route('register') }}" novalidate>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="name" type="text" class="p-3 bg-gray-200 rounded form-input w-full @error('name') @enderror" name="name" value="{{ old('name') }}" autocomplete="name" autofocus>
                            @error('name')
                                <span class="bg-red-100 border-l-4 border-red-500 text-red-700 text-xs p-4 w-full mt-5" role="alert">
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="email" type="email" class="p-3 bg-gray-200 rounded form-input w-full @error('email') @enderror" name="email" value="{{ old('email') }}" autocomplete="email">
                            @error('email')
                                <span class="bg-red-100 border-l-4 border-red-500 text-red-700 text-xs p-4 w-full mt-5" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="password" type="password" class="p-3 bg-gray-200 rounded form-input w-full @error('password') @enderror" name="password" autocomplete="new-password">
                            @error('password')
                                <span class="bg-red-100 border-l-4 border-red-500 text-red-700 text-xs p-4 w-full mt-5" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
